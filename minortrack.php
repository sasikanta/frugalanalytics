...
?>
      ...
      <div class="right_col" role="main">
        ...
        <br />
<?php
$sql="select * from clicktrack where uid='$id' order by ts desc";
...
{
	echo '<tr>';
	echo '<td style="padding-right:14px;padding-top:14px;">';
	echo $row['tag'];
	echo '</td>';
	echo '<td style="padding-right:14px;padding-top:14px;">';
	echo $row['text'];
	echo '</td>';
	echo '<td style="padding-right:14px;padding-top:14px;">';
	$string = (strlen($row['path']) > 50) ? substr($row['path'],0,47).'...' : $row['path'];
	echo $string;
	echo '</td>';
	echo '<td style="padding-right:14px;padding-top:14px;">';
	echo $row['ip'];
